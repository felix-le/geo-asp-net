...
namespace Todos.Controllers
{
    public class TodoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Deadline,DaysTime,TodoName,TodoListModelId")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Deadline,DaysTime,TodoName,TodoListModelId")] Todo todo)
        {
            if (id != todo.Id)
            {
                return NotFound();
